...
if __name__ == '__main__':
    ...
    minVal=numbers_tree.find_min()
    print('The minimum value in the list is: {}'.format(minVal))
    maxVal=numbers_tree.find_max()
    print('The maximum value in the list is: {}'.format(maxVal))
    theSum=numbers_tree.calculate_sum()
    print('The total sum of the numbers is: {}'.format(theSum))